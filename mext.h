...
#define MEXT_COMMAND_LED_OFF       0x0
#define MEXT_COMMAND_LED_OFF_PAYLOAD_SIZE 2
#define MEXT_COMMAND_LED_ON        0x1
#define MEXT_COMMAND_LED_ON_PAYLOAD_SIZE 2
#define MEXT_COMMAND_LED_ALL_OFF   0x2
#define MEXT_COMMAND_LED_ALL_OFF_PAYLOAD_SIZE 0
#define MEXT_COMMAND_LED_ALL_ON    0x3
#define MEXT_COMMAND_LED_ALL_ON_PAYLOAD_SIZE 0
#define MEXT_COMMAND_LED_MAP       0x4
#define MEXT_COMMAND_LED_MAP_PAYLOAD_SIZE 10
#define MEXT_COMMAND_LED_ROW       0x5
#define MEXT_COMMAND_LED_ROW_PAYLOAD_SIZE 3
#define MEXT_COMMAND_LED_COLUMN    0x6
#define MEXT_COMMAND_LED_COLUMN_PAYLOAD_SIZE 3
#define MEXT_COMMAND_LED_INTENSITY 0x7
#define MEXT_COMMAND_LED_INTENSITY_PAYLOAD_SIZE 1
